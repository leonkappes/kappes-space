<svelte:head>
	<title>Leon Kappes | Imprint</title>
</svelte:head>
...
<div class="py-4 px-8 m-0 w-full">
	...
	<p>
		Zuständige Regulierungs-, bzw. Aufsichtsbehörde: Landesanstalt für Medien NRW, <a
			href="https://www.medienanstalt-nrw.de/"
			target="_blank">https://www.medienanstalt-nrw.de/</a
		>
	</p>
	...
	<p>Leon Kappes<br />Thomas-Mann-Str. 27<br />41469 Neuss, Deutschland</p>
	E-Mail-Adresse:
	<p><a href="mailto:leon@kappes.space">leon@kappes.space</a></p>
	Impressum:
	<p><a href="https://kappes.space/imprint" target="_blank">https://kappes.space/imprint</a></p>
	...
	<ul class="m-elements">
		...
		<li>
			<strong>Content-Delivery-Network: </strong>Wir setzen ein "Content-Delivery-Network" (CDN)
		...
		<li>
			...
			und/oder Rechenkapazitäten); <strong>Dienstanbieter:</strong> Hetzner Online GmbH,
			Industriestr. 25, 91710 Gunzenhausen, Deutschland; <strong>Website:</strong>
	...
	<p>
		...
		eingesetzten Dienste einverstanden erklärt haben, können auch Standortdaten verarbeitet werden.
	</p>
	<p>
	...
	<p>
		...
		Einsatz der Drittanbieter bitten, ist die Rechtsgrundlage der Verarbeitung von Daten die Einwilligung.
		Ansonsten werden die Daten der Nutzer auf Grundlage unserer berechtigten Interessen (d.h. Interesse
	...
	<ul class="m-elements">
		<li>
			...
			datenschutzfreundliche Webanalysesoftware, die ohne Cookies eingesetzt wird und bei der die
			Erkennnung wiederkehrender Nutzer mit Hilfe eines so genannten "digitalen Fingerabdrucks"
			erfolgt, der anonymisiert gespeichert und alle 24 Stunden geändert wird; Beim "digitalen
			Fingerabdruck" werden Nutzerbewegungen innerhalb unseres Onlineangebotes mit Hilfe von
			pseudonymisierten IP-Adressen in Kombination mit nutzerseitige Browsereinstellungen so
			erfasst, dass Rückschlüsse auf die Identität einzelner Nutzer nicht möglich sind. Die im
			Rahmen der Nutzung von Matomo erhobenen Daten der Nutzer werden nur von uns verarbeitet und
	...
	<ul class="m-elements">
		<li>
			<strong>Instagram: </strong>Soziales Netzwerk; <strong>Dienstanbieter:</strong> Instagram
			Inc., 1601 Willow Road, Menlo Park, CA, 94025, USA; <strong>Website:</strong>
		...
		<li>
			<strong>LinkedIn: </strong>Soziales Netzwerk; <strong>Dienstanbieter:</strong> LinkedIn
			Ireland Unlimited Company, Wilton Place, Dublin 2, Irland; <strong>Website:</strong>
		...
		<li>
			<strong>TikTok: </strong>Soziales Netzwerk / Video-Plattform; <strong>Dienstanbieter:</strong>
		...
		<li>
			<strong>Twitter: </strong>Soziales Netzwerk; <strong>Dienstanbieter:</strong> Twitter
	...
	<ul class="m-elements">
		<li>
			<strong>YouTube-Videos: </strong>Videoinhalte; <strong>Dienstanbieter:</strong> Google Ireland
			Limited, Gordon House, Barrow Street, Dublin 4, Irland, Mutterunternehmen: Google LLC, 1600
			Amphitheatre Parkway, Mountain View, CA 94043, USA; <strong>Website:</strong>
	...
	<ul class="glossary">
		...
		<li>
			...
			und Interessen, wie z.B. die Interaktion mit Webseiten und deren Inhalten, etc.) zu analysieren,
			zu bewerten oder, um sie vorherzusagen (z.B. die Interessen an bestimmten Inhalten oder Produkten,
			das Klickverhalten auf einer Webseite oder den Aufenthaltsort). Zu Zwecken des Profilings werden
		...
		<li>
			...
			der Reichweitenanalyse können Webseiteninhaber z.B. erkennen, zu welcher Zeit Besucher ihre Webseite
			...
			häufig pseudonyme Cookies und Web-Beacons eingesetzt, um wiederkehrende Besucher zu erkennen und
